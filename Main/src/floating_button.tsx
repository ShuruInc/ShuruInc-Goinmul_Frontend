...
import styles from '../styles/floating_button.module.scss';
...
export default function FloatingButton({type, onClick}: FloatingButtonProp) {
    return <button className={styles.floatingBtn} onClick={onClick}>
        <FontAwesomeIcon icon={type === 'up' ? faChevronUp : faHome}></FontAwesomeIcon> 
    </button>;
}
